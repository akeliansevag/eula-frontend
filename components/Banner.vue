            ...
            <div class="max-lg:w-full w-2/3">
                ...
                <div class="max-lg:flex-col mt-4 flex gap-6">
                    <div class="flex gap-2 items-center">
                        ...
                        <span class="max-lg:text-md text-xl">Pure water</span>
                    </div>
                    <div class="flex gap-2 items-center">
                        <span>
                        ...
                        <span class="max-lg:text-md text-xl">Zero plastic</span>
                    </div>
                    <div class="flex gap-2 items-center">
                        <span>
                            <img src="/public/img/i3.svg" alt="Icon">
                        </span>
                        <span class="max-lg:text-md text-xl">100% sustainable</span>
                    </div>
                </div>
            </div>
